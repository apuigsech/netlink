...
type AuditEvent struct {
	...
	Comm 				interface{}					// comm - encoded, command line program name.
	...
	Exe 				interface{} 				// exe - encoded, executable name
	...
	Key 				interface{} 				// key - encoded, key assigned from triggered audit rule.
